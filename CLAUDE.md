...
- **Container Path**: Model loaded from `/serving/model` (MLflow pyfunc format)
...
- **Actions**: Build Docker image → Push to Docker Hub (`ahmedsherif796/telco-fastapi:latest`)
...
- `n_estimators=618`, `learning_rate=0.0879`, `max_depth=4`
